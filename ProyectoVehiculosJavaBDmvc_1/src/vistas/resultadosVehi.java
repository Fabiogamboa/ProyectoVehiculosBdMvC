...
public class resultadosVehi extends javax.swing.JFrame {
    private DefaultTableModel modeloTabla;
    private String[] columnas = {"Placa", "Marca", "Combustible", "Características", "ID Usuario"};

    public resultadosVehi() {
        initComponents();
        inicializarTabla();
    ...
    private void cargarDatosDeVehiculos() {
        ModeloVehiculo modeloVehiculo = new ModeloVehiculo();
        try {
            List<Object[]> vehiculos = modeloVehiculo.obtenerTodosLosVehiculosDesdeDB();
            if (vehiculos != null && !vehiculos.isEmpty()) {
                for (Object[] vehiculo : vehiculos) {
                    modeloTabla.addRow(vehiculo);
                }
            } else {
